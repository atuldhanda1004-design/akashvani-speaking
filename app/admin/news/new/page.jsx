...
export default function AddNewsPage() {
  ...
  const addHeading = () => {
    setFormData((p) => ({ ...p, points: [...p.points, '[H] '] }))
  }
      ...
      <header className="bg-brand-primary text-white shadow-lg">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <Link
            ...
            className="flex items-center gap-2 text-white/80 hover:text-white text-sm font-poppins"
          >
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl font-yantramanav text-lg outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20"
                />
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl font-yantramanav outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 resize-none"
                />
              </div>

              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                <label className="block text-sm font-poppins font-semibold text-gray-700 mb-3">
                  हेडिंग्स + बुलेट पॉइंट्स *
                </label>
                <p className="text-xs text-gray-500 mb-3 font-poppins">
                  [H] वाली लाइन = बीच की हेडिंग (जैसे पुलिस कार्यवाही). बाकी = bullet points.
                </p>
                  ...
                  {formData.points.map((point, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-start gap-2">
                        <span
                          className={`w-7 h-7 rounded flex items-center justify-center text-xs font-bold shrink-0 mt-1 ${
                            isHeading
                        ...
                        <textarea
                          value={display}
                          onChange={(e) => updatePoint(idx, e.target.value, isHeading)}
                          rows={isHeading ? 1 : 2}
                          placeholder={isHeading ? 'हेडिंग लिखें...' : 'पॉइंट लिखें...'}
                          className={`flex-1 px-4 py-2 border rounded-xl outline-none focus:ring-2 focus:ring-brand-primary/20 ${
                            isHeading
                              ? 'font-bold border-brand-primary/40 text-brand-primary'
                              : 'border-gray-200 text-sm font-yantramanav'
                          }`}
                        />
                        {formData.points.length > 1 ? (
                          <button
                            ...
                            className="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg mt-1"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        ) : null}
                ...
                <div className="flex flex-wrap gap-3 mt-4">
                  <button
                    type="button"
                    onClick={addPoint}
                    className="inline-flex items-center gap-2 px-3 py-2 border-2 border-brand-primary text-brand-primary rounded-lg text-sm font-poppins font-semibold hover:bg-brand-primary hover:text-white"
                  >
                  ...
                  <button
                    type="button"
                    onClick={addHeading}
                    className="inline-flex items-center gap-2 px-3 py-2 bg-gray-800 text-white rounded-lg text-sm font-poppins font-semibold hover:bg-black"
                  >
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                {imageFiles.length > 0 ? (
                  <p className="text-xs text-green-600 mt-2 font-poppins">
                    {imageFiles.length} फोटो selected
                  </p>
                ) : null}
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl font-poppins text-sm outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20"
                />
                <p className="text-xs text-gray-400 mt-2">
                  Short News में भी यही वीडियो दिखेगी अगर URL डाला है।
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <select
                  ...
                  required
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl font-yantramanav text-sm outline-none focus:border-brand-primary bg-white"
                >
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <input
                  ...
                  placeholder="भिवानी, रोहतक..."
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl font-yantramanav text-sm outline-none focus:border-brand-primary"
                />
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 space-y-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-sm font-poppins font-medium text-gray-700">ट्रेंडिंग / Live carousel</span>
                    <p className="text-[11px] text-gray-400">ऊपर वाले scroll सेक्शन में</p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-sm font-poppins font-medium text-gray-700">ब्रेकिंग / LIVE</span>
                    <p className="text-[11px] text-gray-400">लाल LIVE बैज</p>
                  </div>
                </label>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                <button
                  ...
                  className="w-full py-3 bg-brand-primary text-white rounded-xl font-poppins font-semibold text-sm flex items-center justify-center gap-2 hover:bg-brand-secondary disabled:opacity-50"
                >
                  {isSubmitting ? (
                    'Submit हो रहा है...'
                  ) : (
