...
export default async function CategoryPage({ params }) {
  ...
  const allNews = data?.length
    ? data
    : [...dummyTrendingNews, ...dummyLatestNews].filter((n) => n.categories?.slug === params.slug)
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        {allNews.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 font-yantramanav text-lg mb-4">इस कैटेगरी में अभी कोई खबर नहीं है।</p>
