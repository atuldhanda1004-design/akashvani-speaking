...
export const dummyTrendingNews = [
  ...
  },
  {
    ...
    featured_image: 'https://images.unsplash.com/photo-1589923158776-cb4485d99fd6?w=1200&q=80',
    location: 'जींद',
  ...
  },
  {
    ...
    featured_image: 'https://images.unsplash.com/photo-1591696205602-2f950c417cb9?w=1200&q=80',
    location: 'रोहतक',
...
export const dummyLiveUpdates = [
  { id: 1, time: '10:30 AM', headline: 'हरियाणा के कई जिलों में बारिश का अलर्ट जारी', slug: 'rain-alert-haryana-districts' },
  { id: 2, time: '09:45 AM', headline: 'कुरुक्षेत्र में गीता जयंती की तैयारियां तेज', slug: 'kurukshetra-geeta-jayanti' },
  { id: 3, time: '09:15 AM', headline: 'पंचकूला में ट्रैफिक व्यवस्था में बदलाव', slug: 'panchkula-traffic-changes' },
  { id: 4, time: '08:30 AM', headline: 'डीजीपी ने पुलिस अधिकारियों को दिए सख्त निर्देश', slug: 'dgp-strict-orders-police' },
  { id: 5, time: '07:45 AM', headline: 'हरियाणा में शिक्षा बोर्ड ने बदले नियम', slug: 'education-board-new-rules' },
]

export const dummyShortNews = [
  { id: 1, headline: 'हरियाणा सरकार ने बढ़ाई पेंशन', summary: 'राज्य सरकार ने बुजुर्ग पेंशन में ₹500 की बढ़ोतरी की घोषणा की।', category: 'हरियाणा', time: '2 घंटे पहले' },
  { id: 2, headline: 'दिल्ली-मुंबई एक्सप्रेसवे का काम तेज', summary: 'हरियाणा से गुजरने वाले एक्सप्रेसवे का 70% काम पूरा हो चुका है।', category: 'देश', time: '3 घंटे पहले' },
  { id: 3, headline: 'हरियाणा बोर्ड 10वीं का रिजल्ट जल्द', summary: 'बोर्ड ने कहा अगले हफ्ते तक रिजल्ट जारी किया जाएगा।', category: 'शिक्षा', time: '4 घंटे पहले' },
  { id: 4, headline: 'किसानों को मिलेगा बोनस', summary: 'सरकार ने गेहूं पर ₹200 प्रति क्विंटल बोनस का ऐलान किया।', category: 'हरियाणा', time: '5 घंटे पहले' },
  { id: 5, headline: 'नई मेट्रो लाइन का ऐलान', summary: 'गुरुग्राम से फरीदाबाद तक नई मेट्रो लाइन बनेगी।', category: 'हरियाणा', time: '6 घंटे पहले' },
]
